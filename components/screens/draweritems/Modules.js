    ...
    render() {
        return(
            <ModuleScreen
                ...
                descriptionImage = {require('./../../../assets/communication.png')}
    ...
    render() {
        return(
            <ModuleScreen
                ...
                descriptionImage = {require('./../../../assets/goalsetting.png')}
    ...
    render() {
        return(
            <ModuleScreen
                ...
                descriptionImage = {require('./../../../assets/ideation.png')}
    ...
    render() {
        return(
            <ModuleScreen
                ...
                descriptionImage = {require('./../../../assets/teambuilding.png')}
